...
platforms = ["Atari Panther", "Nintendo 64", "Nintendo GameCube", "Nintendo Wii", "Nintendo Wii U", "Playstation 1", "Playstaion 2", "Playstation 3", "Playstation 4", "Sega Dreamcast", "Sega Genesis", "Super Nintendo"]
...
kojo = User.create!(email:"kojo@rever.com", password:"qqqqqq", imagelink: "everett.png", fullname: "Kojo")
everett = User.create!(email:"everett@rever.com", password:"qqqqqq", imagelink: "kojo.png", fullname: "Everett")
...
stephanie = User.create!(email:"stephanie@rever.com", password:"qqqqqq", imagelink: "stephaniee.png", fullname: "Stephanie")
...
meetup3 = Meetup.create!(title: "FORNITE SHOWDOWN", description: "Come join my fornight office party (we have a keg!) :)", location: "Coopérative d'habitation du Châtelet, 5308A Av du Parc, Montréal, QC H2V 4G7", start_time: Time.now, end_time: Time.now + 1*60*60, date: Time.now, user:mg, game:Game.find(Game.first.id + 5))
...
Guest.create!(current_status:"Pending", user:elie, meetup:meetup3)
